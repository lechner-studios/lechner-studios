...
- Flagship offer for Pensionen/Ferienwohnungen — "Direktbucher" (a website that takes direct bookings, cutting the commissions charged by online travel agencies / booking portals — OTA, e.g. Booking.com): Basis €3.900, Komplett €6.900 (most popular), Premium €9.900; optional care plan €99/€149/€199 per month (includes hosting, business email, SSL, maintenance, updates, backups; domain 1st year included); typically live in 2 weeks. Details at https://werk.lechner-studios.at/pension-website-tirol, and a live example at https://demos.lechner-studios.at/pension (labelled Beispielentwurf, not a real client). Booking portals take roughly 15 % per booking, which is the saving this offer targets. The werk offer page has no commission calculator, so do not promise one there; the blog post at /${locale}/blog/direct-booking-website-pension does have an interactive one a visitor can try, and you may point them to it. It computes from the visitor's own revenue and rate, so never quote a figure from it yourself.
