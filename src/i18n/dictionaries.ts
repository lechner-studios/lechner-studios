export const dictionaries = {
  en: {
    ...
    meta: {
      ...
      homeDescription:
        "Family-run, AI-native digital studio in Wattens, Tirol. Websites, automation and SEO for SMBs across DACH. Brand & identity are part of every project.",
      ogLocale: "en_US",
      orgDescription:
    ...
    blogFigure: {
      "type-mood-craft": {
        ALT: "The same joinery workshop presented in two different brand systems",
        EYEBROW: "SAME WORKSHOP, SAME OFFER",
        CAPTION: "Identical text, identical offer. Only the colour and the typeface differ.",
        TAG_A: "Workshop A",
        TAG_B: "Workshop B",
        NAME: "Tischlerei am Inn",
        SUB: "Made-to-measure furniture",
        BODY: "Fitted wardrobes, kitchens and interior joinery. Design, build and installation from one workshop.",
        CTA: "Request an appointment",
      },
      "type-mood-trust": {
        ALT: "The same accountancy firm presented in two different brand systems",
        EYEBROW: "SAME FIRM, SAME SERVICES",
        CAPTION: "Identical services, identical wording. Only the palette and the typeface differ.",
        TAG_A: "Version one",
        TAG_B: "Version two",
        NAME: "Ridgeway & Partners",
        SUB: "Chartered accountants",
        BODY: "Year-end accounts, payroll and tax returns for owner-managed businesses across the region.",
  ...
  de: {
    ...
    meta: {
      ...
      homeDescription:
        "Familiengeführtes, KI-natives Digitalstudio in Wattens, Tirol. Websites, Automatisierung und SEO für KMU. Marke & Identität gehören immer dazu.",
      ogLocale: "de_AT",
      orgDescription:
    ...
    blogFigure: {
      "type-mood-craft": {
        ALT: "Derselbe Tischlereibetrieb in zwei unterschiedlichen Markensystemen",
        EYEBROW: "GLEICHER BETRIEB, GLEICHES ANGEBOT",
        CAPTION: "Identischer Text, identisches Angebot. Nur Farbe und Schrift unterscheiden sich.",
        TAG_A: "Betrieb A",
        TAG_B: "Betrieb B",
        NAME: "Tischlerei am Inn",
        SUB: "Möbel nach Maß",
        BODY: "Einbauschränke, Küchen und Innenausbau. Planung, Fertigung und Montage aus einer Hand.",
        CTA: "Termin anfragen",
      },
      "type-mood-trust": {
        ALT: "Dieselbe Steuerberatungskanzlei in zwei unterschiedlichen Markensystemen",
        EYEBROW: "GLEICHE KANZLEI, GLEICHE LEISTUNGEN",
        CAPTION: "Identische Leistungen, identischer Wortlaut. Nur Farbe und Schrift unterscheiden sich.",
        TAG_A: "Variante eins",
        TAG_B: "Variante zwei",
        NAME: "Ridgeway & Partner",
        SUB: "Steuerberatung",
