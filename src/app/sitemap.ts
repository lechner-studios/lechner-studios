...
const routes = ["", "/work", "/about", "/blog", "/contact", "/start", "/webdesign", "/apps-automation", "/seo", "/marke-identitaet", "/website-check", "/pension-website-tirol", "/impressum", "/privacy"] as const;
