...
description: "What your website has to do technically so local customers find you through search — from structured data to fast mobile pages. Explained technically, without advertising promises."
...
**Fast, mobile pages.** Local search happens predominantly on a phone, often on the move. A page that loads sluggishly on mobile loses the person back to the results list — and weak mobile load times also feed directly into ranking. We've covered elsewhere just how much [load time decides customers won or lost](/en/blog/why-slow-websites-lose-customers).
